  ...
  return `
    <section class="contents-works">
        ...
        ${template({
          title: '환자 관리 시스템',
          team: false,
          github: 'https://github.com/IRONDESK/patients_manage',
          duration: '2022. 05',
          member: 'Front-End 1명',
          summary: '환자 정보 열람 및 통계 차트 제공',
          detail: [
            '페이지 전체 UI 디자인 기획',
            'Axios를 활용한 API 통신 및 서비스 구현',
            'useState, useEffect 등 Hook을 활용한 환자 정보 열람 및 정렬, 필터링 구현',
            'recharts를 활용한 통계 그래프 구현',
          ],
          stack: ['HTML', 'CSS(@emotion)', 'React', 'Next.js', 'recharts'],
          link: 'https://github.com/IRONDESK/patients_manage',
          thumbnail: './img/thumnail/10.png',
        })}
        ${template({
          title: 'MOSS 모여라 스터디',
          team: true,
          ...
          member: 'Front-End/Back-End 5명',
          summary: '스터디 그룹 연결 및 서포트 플랫폼',
          detail: [
            '반응형을 포함한 스터디 페이지 프론트엔드 기능 구현',
            'd3.js로 벡터 이미지 형식의 과제 달성율 차트 구현',
        ...
        ${template({
          ...
          detail: [
            '스포티파이 API를 활용한 트렌드성 테스트 서비스 구현',
        ...
        ${template({
          ...
          detail: [
            'Node.js와 MongoDB를 활용한 CRUD 영화 기록 서비스 구현',
